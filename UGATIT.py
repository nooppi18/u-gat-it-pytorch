...
class UGATIT(object) :
    ...
    def build_model(self):
        ...
        self.disGA = Discriminator(input_nc=3, ndf=self.ch, n_layers=6).to(self.device)
        self.disGB = Discriminator(input_nc=3, ndf=self.ch, n_layers=6).to(self.device)
        self.disLA = Discriminator(input_nc=3, ndf=self.ch, n_layers=4).to(self.device)
        self.disLB = Discriminator(input_nc=3, ndf=self.ch, n_layers=4).to(self.device)
